...
def player_mode():
    ...
    while run:
        ...
        if not game_over:
            ...
            win.blit(menu_text, (menu_button.centerx - menu_text.get_width()//2, menu_button.centery - menu_text.get_height()//2))
            pygame.display.update()

def ai_mode(config_path):
...
def menu():
    ...
    while menu_running:
        ...
        win.blit(ai_text, (ai_button.centerx - ai_text.get_width()//2, ai_button.centery - ai_text.get_height()//2))
        win.blit(player_text, (player_button.centerx - player_text.get_width()//2, player_button.centery - player_text.get_height()//2))
